...
print ("Temperaturas extremas del rango" , db.temp_extremos_rango(date (2023,7,1), date (2023,9,1) ))
    
print("Borrar la temperatura del 1/6/2023")
db.borrar_temperatura(date(2023,1,6))
